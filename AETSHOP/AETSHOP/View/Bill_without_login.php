...
?>
        <div class="card-body">
            <div class="container mb-5 mt-3">
                ...
                <div class="row d-flex align-items-baseline">
                    <div class="col-xl-9">
                        <p style="color: #7e8d9f;font-size: 20px;">Số hóa đơn &gt;&gt; <strong>ID:
                                <?php echo $idhd ?></strong></p>
                    </div>
                </div>
                <div class="container">
                    <div class="col-md-12 rounded" style="background-color:#2579f2">
                        <div class="text-left pt-2">
                            <h1 class="logo me-auto text-white text-uppercase "><img src="././assets/img/logo-w.png" alt="logo" class="pb-1" width="7%" class="img-fluid mt-0"> <span class="mt-3">AETSHOP</span></h1>
                        </div>
                    </div>
                    <div class="row mt-4">
                        ...
                        <div class="col-xl-7">
                            <ul class="list-unstyled">
                                <li class="text-muted">Khách hàng: <span style="color:#2579f2 ;"><?php echo $userInfo['tenkh'] ?>
                                    </span></li>
                                <li class="text-muted"><i class='fas fa-location-arrow'></i> <?php echo $userInfo['diachi'] ?>
                                </li>
                        ...
                        <div class="col-xl-5">
                            <ul class="list-unstyled">
                                ...
                                <li class="text-muted"><i class="fas fa-circle" style="color:#2579f2 ;"></i>
                                    <span class="fw-bold">Ngày tạo đơn: </span><?php echo $info_order['ngaydat'] ?>
                                </li>
                                <li class="text-muted"><i class="fas fa-circle" style="color:#2579f2;"></i>
                    ...
                    ?>
                        <div class="row my-2 mx-1 justify-content-center">
                            ...
                            <div class="col-md-6 mb-4 mb-md-0">
                                ...
                                <strong><span class="text-info me-2">Số lượng</span><span class="text-success"><?php echo $item['soluongmua'] ?></span></strong>
                            </div>
        ...
        <div class="row">
            <div class="col-12 text-center">
                <h2>Cảm ơn bạn đã quan tâm AETSHOP!</h2>
            </div>
        </div>
<?php
    } else {
