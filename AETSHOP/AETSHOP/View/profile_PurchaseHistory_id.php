                ...
                ?>
                                ...
                                <div class="container">
                                    <div class="col-md-12 rounded" style="background-color:#2579f2">
                                        <div class="text-left pt-2">
                                            <h1 class="logo me-auto text-white text-uppercase "><img src="././assets/img/logo-w.png" alt="logo" class="pb-1" width="7%" class="img-fluid mt-0"> <span class="mt-3">AET SHOP</span></h1>
                                        </div>
                                    </div>
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-xl-7">
                                            <ul class="list-unstyled">
                                                <li class="text-muted">Khách hàng: <span style="color:#2579f2 ;"><?php echo $_SESSION['tenkh'] ?> </span></li>
                                                <li class="text-muted"><i class='fas fa-location-arrow'></i>
                                                    <?php echo $_SESSION['diachi'] ?></li>
                                                <li class="text-muted"><i class="fas fa-phone"></i>
                                                    <?php echo $_SESSION['sodienthoai'] ?></li>
                                            </ul>
                                        </div>
                                        <div class="col-xl-5">
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="text-muted"><i class="fas fa-circle" style="color:#2579f2 ;"></i>
                                                    <span class="fw-bold">Ngày tạo đơn:
                                                    </span><?php echo $info_order['ngaydat'] ?>
                                                </li>
                                                <li class="text-muted"><i class="fas fa-circle" style="color:#2579f2;"></i>
                                            ...
                                            <div class="col-md-4 mb-4 mb-md-0">
                                                ...
                                                ?>
                                                    ...
                                                    <p class="text-danger"><small>Tiết kiệm
                                                            <?php echo   FLOOR(100 - ($item['giamgia'] / $item['dongia']) * 100) . '%' ?></small>
                                                    </p>
                                                <?php
                                                } ?>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-12 text-center">
                                <h2>Cảm ơn bạn đã mua hàng tại AETSHOP!
                                </h2>
                            </div>
                        </div>
                <?php
