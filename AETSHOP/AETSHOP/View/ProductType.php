        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 col-sm-12">
                ...
                if (isset($_GET['type'])) {
                    ...
                    echo '<h2> Các sản phẩm ' . $menu['name2'] . '</h2>';
                    echo '<title>Shop - ' . $menu['name2'] . '</title>';
                ?>
            </div>
                    ...
                    <div class="row w-100">
                        ...
                        <div class="col-5">
                            ...
                            <select class="form-select w-100" aria-label="Default select example" name='priceSort'>
                                <option <?php echo ($priceSort == 'Normal') ? ' selected' : '' ?> value="Normal">Normal
                                </option>
                                <option <?php echo ($priceSort == 'Desc') ? ' selected' : '' ?> value="Desc">High to low
                                </option>
                                <option <?php echo ($priceSort == 'Asc') ? ' selected' : '' ?> value="Asc">Low to high
                                </option>
                            </select>
                        </div>
                        <div class="col-2">
