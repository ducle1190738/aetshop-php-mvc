        ...
        <section class="panel">
            <div class="panel-body">
                <form action="index.php?action=Cart" method="post">
                    ...
                    <title>AET SHOP - <?php echo $tenhh ?></title>
                    <div class="row mt-4">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="product_meta pt-4">
                                <span class="tagged_as"><strong>Thẻ:</strong>
                                    <a class='text-info' rel="tag"
                                        href="index.php?action=Shop&type=<?php echo $Category2 ?>"><?php echo $Category2 ?></a>
                                </span>
                            </div>
                            <div class="product_meta pt-4">
                                <span class="tagged_as"><strong>Đánh giá:</strong>
                                    <?php echo number_format($rating, 1) ?><i class='fas fa-star'
                                        style='font-size:20px;color:#fcd303'></i>( <?php echo $countRating ?> đánh giá)
                                </span>
                            </div>
                            <div class="product_meta">
                                ...
                                ?>
                                <a href="index.php?action=Details&id=<?php echo $set['mahh']; ?>"
                                    class="thoihansp mb-2 btn <?php echo $mahh == $set['mahh'] ? 'btn-info text-white' : 'btn-outline-info' ?> <?php echo $set['soluongton'] == 0 ? 'disabled' : ''  ?>"><?php echo $set['thoihan']; ?></a>
                                <?php
                                endwhile;
                                ?>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <h4 class="text-muted text-decoration-line-through">
                                            <?php echo number_format($dongia) ?><sup><u>đ</u></sup></h4>
                                    </div>
                            ...
                            <div class="input-group mt-2 mb-2 w-25 "
                                style="display:<?php echo $soluong <= 0 ? 'none' : 'flex'; ?>">
                                <div class="form-outline">
                                    <input type="number" id="typeNumber" class="form-control quantity" name="soluong"
                                        min="1" value="" max="<?php echo $soluong; ?>" />
                                    <label class=" form-label" for="soluong">Số lượng mua</label>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-3">
                                    <button class="btn btn-round btn-primary w-100" type="submit"
                                        <?php if ($soluong <= 0) echo 'disabled' ?> id="buy-button">
                                        <i class='fas fa-cart-arrow-down'></i> Mua ngay</button>
                                </div>
                                <div class="col-3">
                                    <a class="btn btn-success w-200 text-white <?php if ($soluong <= 0) echo 'disabled' ?>"
                                        role="button" href="index.php?action=Cart&act=add-to-cart">
                    ...
                    <div class="col-md-6">
                        ...
                        <form method="post" action="index.php?action=Details&id=<?php echo $mahh ?>&act=addwishlist">
                            ...
                            <button class="btn btn-round btn-danger text-light" type="submit" disabled><i
                                    class="fas fa-heart"></i> Thêm vào yêu thích</button>
                        </form>
                        <?php
                            } else {
                            ?>
                        <form method="post" action="index.php?action=Details&id=<?php echo $mahh ?>&act=addwishlist">
                            <input type="hidden" name="makh" value="<?php echo $makh ?>">
                            <button class="btn btn-round btn-danger" type="submit"><i class="far fa-heart"></i> Thêm vào
                                yêu thích</button>
                        </form>
                        <?php
                            }
    ...
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <button class="nav-link active" id="nav-reviews-tab" data-bs-toggle="tab" data-bs-target="#nav-reviews"
                type="button" role="tab" aria-controls="nav-reviews" aria-selected="true"><i
                    class="bi bi-star-fill"></i> Đánh giá</button>
            <button class="nav-link" id="nav-comment-tab" data-bs-toggle="tab" data-bs-target="#nav-comment"
                type="button" role="tab" aria-controls="nav-comment" aria-selected="false"><i
                    class="bi bi-chat-right-dots-fill"></i> Bình luận</button>
        </div>
    </nav>
            ...
            <div class="be-comment-block">
                ...
                if (isset($_SESSION['makh'])) {
                    ...
                    if ($checkBuy) {
                        ...
                        if (!$checkRated) {
                ?>
                <form class="form-block" action="index.php?action=Details&id=<?php echo $mahh ?>&act=rating"
                    method="post">
                    <div class="row">
                        <div class="col-xs-9 col-sm-8">
                            <ul class="list-unstyled">
                                <li class="text-muted"><strong><i class="bi bi-person"></i> Your Name: </strong><span
                                        style="color:#2579f2 ;"> <?php echo $_SESSION['tenkh'] ?> </span></li>
                                <li class="text-muted"><strong><i class="bi bi-envelope"></i> Your Email: </strong><span
                                        style="color:#2579f2 ;"> <?php echo $_SESSION['email'] ?></span></li>
                            </ul>
                        </div>
                        <div class="col-xs-3 col-sm-4">
                            <ul class="list-unstyled">
                                <li class="text-muted"><strong><i class="bi bi-calendar-check"></i> Time purchase:
                                    </strong><span style="color:#2579f2 ;"> <?php echo $checkBuy['ngaydat'] ?> </span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="row">
                                ...
                                <div class="col-9  mt-1">
                                    ...
                                    <img src="assets\img\star2.png" onmouseover="change(this.id);" id="php1" class="php"
                                        width="20px">
                                    <input type="hidden" id="php2_hidden" value="2">
                                    <img src="assets\img\star2.png" onmouseover="change(this.id);" id="php2" class="php"
                                        width="20px">
                                    <input type="hidden" id="php3_hidden" value="3">
                                    <img src="assets\img\star2.png" onmouseover="change(this.id);" id="php3" class="php"
                                        width="20px">
                                    <input type="hidden" id="php4_hidden" value="4">
                                    <img src="assets\img\star2.png" onmouseover="change(this.id);" id="php4" class="php"
                                        width="20px">
                                    <input type="hidden" id="php5_hidden" value="5">
                                    <img src="assets\img\star2.png" onmouseover="change(this.id);" id="php5" class="php"
                                        width="20px">
                                </div>
                ...
                <?php
                        ...
                        Bạn cần <a class="text-danger" href="#top">mua</a> sản phẩm để đánh giá</h4>';
                    }
                } else {
                    echo '<h4 class="text-warning">
                    Bạn cần <a href="index.php?action=User&act=login" class="text-danger">đăng nhập</a> và mua sản phẩm để đánh giá</h4>';
                }
                ...
                <div class="be-comment">
                    <div class="be-comment-content">
                        <h2 class="be-comment-text">
                            <i class='fas fa-star'></i> Hiện tại không có đánh giá nào
                        </h2>
                    </div>
                </div>
                <?php
                ...
                ?>
                <h1 class="comments-title">Đánh giá (<?php echo $count; ?> )</h1>
                <?php
        ...
        <div class="tab-pane fade" id="nav-comment" role="tabpanel" aria-labelledby="nav-comment-tab">
            <div class="be-comment-block">
                ...
                if (isset($_SESSION['makh'])) {
                    $order = new hoadon();
                ?>
                <form class="form-block" action="index.php?action=Details&id=<?php echo $mahh ?>&act=comment"
                    method="post">
                    <div class="row">
                        ...
                        <div class="col-xs-12 ">
                            <div class="form-outline mb-4">
                                <textarea class="form-control" id="textAreaExample6" rows="3" name="comment"
                                    required></textarea>
                ...
                <?php
                    ...
                    echo '<h4 class="text-warning">Bạn cần <a href="index.php?action=User&act=login" class="text-danger">đăng nhập</a> để bình luận</h4>';
                }
                $usr = new User();
        ...
        <div class="row pb-5 pt-4">
            <div class="row">
                ...
                <div class="col-4 text-right">
                    <a type="button" name="" id="" class="btn btn-primary"
                        href="index.php?action=Shop&type=<?php echo $Category ?>">Xem thêm</a>
                </div>
            </div>
            <?php
            $hh = new hanghoa();
