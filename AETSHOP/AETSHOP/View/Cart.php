                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center align-middle">Đã giảm</th>
                            <th class="text-center align-middle">Tổng</th>
                            <th colspan="2" class="text-right align-middle">
                                <button type='submit' name="" id=""
                                    class="btn btn-warning fw-bolder text-white <?php echo $dis ?>" href="#"
                                    role="button"><i class="bi bi-arrow-repeat"></i> Cập nhật</button>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                                ...
                                <div class="row">
                                    <div class="col-lg-4  col-md-12 col-sm-12">
                                        <a class="thumbnail pull-left"
                                            href="index.php?action=Details&id=<?php echo $item['mahh']; ?>">
                                            <img class="media-object"
                                                src="assets\img\sanpham\<?php echo $item['hinh'] ?>" style="width:100%">
                                        </a>
                                    </div>
                                    <div class=" col-lg-8 col-md-12 col-sm-12">
                                        <h4 class="media-heading"><a
                                                href="index.php?action=Details&id=<?php echo $item['mahh']; ?>"><?php echo $item['name'] ?></a>
                                        </h4>
                                        <div class="row m-0 text-left">
                                            ...
                                            <div class="col-4 giamgiacart">
                                                <p class="text-white">
                                                    <?php echo "-" . FLOOR(100 - ($item['giamgia'] / $item['dongia']) * 100) . '%' ?>
                                                </p>
                                            </div>
                                            <?php
                                                } ?>
                            ...
                            <td class="col-sm-1 col-md-1 pt-4 text-center align-middle">
                                <input type="number" class="form-control" id="exampleInputEmail1"
                                    name="newqty[<?php echo $key ?>]" value="<?php echo $item['soluong'] ?>">
                            </td>
                            ...
                            <td class="col-sm-1 col-md-1 text-right pt-4 align-middle">
                                <button type="button" class="btn btn-danger deletebtn"
                                    onclick="AskBeforeDelete(<?php echo $key ?>)">
                        ...
                        <tr class="text-right ">
                            ...
                            <td>
                                <button name="" id=""
                                    class="btn btn-danger mt-2 fw-bolder text-white <?php echo $dis ?>"
                                    onclick="DeleteAll()" type="button">Xóa tất cả</button>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                <a href='index.php?action=Shop' class="btn btn-secondary  text-left">
                                    <span class="glyphicon glyphicon-shopping-cart"></span> Tiếp tục mua sắm </a>
                            </td>
                            <td colspan="2" class="text-right">
                                ...
                                ?>
                                Số dư của bạn:
                                <h4 class="<?php echo $_SESSION['sodu'] < $tong ? 'text-danger' : 'text-success' ?>">
                                    <?php echo number_format($_SESSION['sodu'], 2) . 'đ' ?></h4>
                                <?php
                                }
                                ?>
                            </td>
                            <td colspan="2" class="text-right">
                                <a class="btn btn-success w-100" <?php echo $dis ?> href="index.php?action=Order">
                                    Thanh toán
