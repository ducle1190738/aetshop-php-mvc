                    ...
                    <div class="card-body px-4 py-5 px-md-5">
                        <form action="index.php?action=User&act=registration" method="POST">
                            ...
                            <div class="form-outline mt-4">
                                ...
                                <label class="form-label" for="Your Address">Địa chỉ</label>
                            </div>
                            <div class="form-outline mt-4">
                        ...
                        <p class="pt-2 pb-lg-2" style="color: #393f81;">Bạn chưa có tài khoản? <a href="index.php?action=User&act=login" style="color: #393f81;">Đăng nhập tại đây</a></p>
                    </div>
                </div>
            </div>
        </div>
