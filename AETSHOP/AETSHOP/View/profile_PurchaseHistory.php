...
<title>Khách hàng - Lịch sử thanh toán</title>
    ...
    <div class="row">
        ...
        <div class="col-lg-9 my-lg-0 my-1">
            <div id="main-content" class="bg-white border">
                <div class="text-uppercase"><i class="bi bi-receipt-cutoff"></i> Lịch sử thanh toán</div>
                <?php
                $order = new hoadon();
                ...
                ?>
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th class="align-middle fw-bolder">ID hóa đơn</th>
                                <th class="text-left align-middle fw-bolder">Thời gian thanh toán</th>
                                <th class="text-center align-middle fw-bolder">Tổng tiền</th>
                                <th class="text-center align-middle fw-bolder">Trạng thái</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center align-middle"><?php echo  number_format($set['tongtien'], 2) ?>
                                        <u>đ</u>
                                    </td>
                                    <td class="text-center align-middle">
                                        <div class="bg-success text-center text-white rounded"><?php echo  $set['tinhtrang'] ?>
                                        </div>
                                    </td>
                                </tr>
                            <?php
