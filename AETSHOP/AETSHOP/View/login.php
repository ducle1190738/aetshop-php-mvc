                        ...
                        <div class="col-md-6 col-lg-7 d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                <form action='index.php?action=User&act=login-to' method='post'>
                                    ...
                                    <a class="small text-muted" href="index.php?action=RestPass">Quên mật khẩu?</a>
                                    <?php
                                    if (!$email_error) {
                                        echo '<p class="mb-5 pb-lg-2" style="color: #393f81;">Bạn chưa có tài khoản? <a href="index.php?action=User&act=sign-up" style="color: #393f81;">Đăng ký tại đây</a></p>';
                                    }
                                    ?>
                                </form>
                            </div>
