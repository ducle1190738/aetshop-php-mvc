...
<title>Khách hàng- Danh sách yêu thích</title>
    ...
    <div class="row">
        ...
        <div class="col-lg-9 my-lg-0 my-1">
            <div id="main-content" class="bg-white border">
                <div class="text-uppercase"><i class="bi bi-box2-heart"></i> Danh sách yêu thích</div>
                <?php
                $us = new User();
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center align-middle">Được giảm</th>
                            <th colspan="2" class="text-right align-middle">
                                <button type='button' name="" id="" class="btn btn-warning fw-bolder text-white"
                                    onclick="DeleteAllitemWishList(<?php echo $_SESSION['makh'] ?>)"><i
                                        class="bi bi-trash3-fill"></i>Xóa tất cả</button>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                                ...
                                <div class="row">
                                    <div class="col-lg-4  col-md-12 col-sm-12">
                                        <a class="thumbnail pull-left"
                                            href="index.php?action=Details&id=<?php echo $set['mahh']; ?>">
                                            <img class="media-object"
                                                src="assets\img\sanpham\<?php echo $set['hinh'] ?>" style="width:100%">
                                        </a>
                                    </div>
                                    <div class=" col-lg-8 col-md-12 col-sm-12">
                                        <h4 class="media-heading"><a
                                                href="index.php?action=Details&id=<?php echo $set['mahh']; ?>"><?php echo $set['tenhh'] ?></a>
                                        </h4>
                            ...
                            <td class="col-sm-1 col-md-1 text-right pt-4 align-middle">
                                <button type="button" class="btn btn-danger deletebtn"
                                    onclick="AskBeforeDelete(<?php echo $_SESSION['makh'] . ',' . $set['mahh'] ?>)">
                ...
                <?php
                    ...
                    echo '<h3 class="text-primary">Bạn chưa có sản phẩm trong danh sách yêu thích</h3>';
                    echo '<h5 class="text-primary">Xem thêm các sản phẩm khác của shop <a class="text-danger" href="index.php?action=Shop"> tại đây</a></h5>';
                }
                ?>
            </div>
        </div>
