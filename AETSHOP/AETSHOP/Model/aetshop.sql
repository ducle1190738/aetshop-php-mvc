...
INSERT INTO `menu` (`idmenu`, `name`,`name2`,`link`) VALUES
(1, 'Trang Chủ', 'Trang Chủ', 'index.php'),
(2, 'Entertainment','Giải trí', 'View/Entertainment.php'),
(3, 'Work','Làm việc', 'View/Work.php'),
(4, 'Learn','Học tập', 'View/Learn.php'),
(5, 'Game Steam','Steam', 'View/GameSteam.php'),
(6, 'Origin','Origin', 'View/Origin.php'),
(7, 'Windows','Windows', 'View/Windows.php'),
(8, 'Drive','Drive', 'View/Drive.php'),
(9, 'Wallet','Wallet', 'View/Wallet.php'),
(10, 'iTunes','iTunes', 'View/iTunes.php'),
(11, 'Liên Hệ','Liên Hệ', 'View/lienhe.php'),
(12, 'Tài Khoản','Tài Khoản', 'View/gioithieu.php');
