...
class hoadon
{
    ...
    public function CreateOrder($makh)
    {
        ...
        $query = "insert into hoadon(masohd,makh,ngaydat,tongtien,tinhtrang) values(NULL,$makh,'$dateCreate',0,'Đã thanh toán')";
        $db->exec($query);
    ...
    public function InsertOrder($makh, $dateCreate, $total)
    {
        ...
        $query = "insert into hoadon(masohd,makh,ngaydat,tongtien,tinhtrang) values(NULL,$makh,'$dateCreate',$total,'Đã thanh toán')";
        $db->exec($query);
